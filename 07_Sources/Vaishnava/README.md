...
Este directorio registra las fuentes normativas y secundarias del Motor
Vaiṣṇava.

## Autoridad Principal v1.0
...
| Prioridad | Tema | Fuente | Uso |
|---|---|---|---|
| ⭐⭐⭐⭐⭐ | Ekādaśī, viddhā, Mahādvādaśī, parāṇa | Hari-bhakti-vilāsa, Vilāsas 12-13 | Extraer reglas normativas |
| ⭐⭐⭐⭐☆ | Ambigüedades de interpretación | Digdarśinī-ṭīkā | Resolver lectura normativa tradicional |
| ⭐⭐⭐⭐☆ | Aplicación Gauḍīya moderna | Navadvīpa Pañjikā | Confirmar práctica de la tradición |
| ⭐⭐⭐☆☆ | Citas originales | Purāṇas citados por HBV | Confirmar solo si hace falta |

## Uso De Internet

Internet ya no es fuente de reglas normativas.

Uso permitido:

- localizar fuentes;
- descargar o verificar una edición;
- revisar datos bibliográficos.

Uso no permitido:

- definir reglas;
- reemplazar Hari-bhakti-vilāsa;
- reemplazar Digdarśinī;
- completar lagunas con resúmenes o páginas secundarias.

## Fuera De Alcance Actual

No se priorizan por ahora:

- lectura completa de Padma Purāṇa;
- lectura completa de Brahma-vaivarta Purāṇa;
- lectura completa de Nārada Purāṇa;
- māhātmyas completos de Ekādaśī;
- relatos devocionales no necesarios para reglas de calendario.
